...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in astar_pb2_grpc.py depends on'
...
class AStarServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.Solve = channel.unary_unary(
                ...
                response_deserializer=astar__pb2.SolveResponse.FromString,
...
def add_AStarServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Solve': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=astar__pb2.SolveResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'astar.proto.AStarService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('astar.proto.AStarService', rpc_method_handlers)
...
class AStarService:
    ...
    def Solve(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/astar.proto.AStarService/Solve',
            astar__pb2.SolveRequest.SerializeToString,
            astar__pb2.SolveResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
